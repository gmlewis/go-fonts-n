...
import (
  ...
  _ "github.com/gmlewis/go-fonts-n/fonts/naturallog"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from naturallog"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "naturallog", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
